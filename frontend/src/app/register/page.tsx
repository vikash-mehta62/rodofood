...
import { ArrowRight, Loader2, Eye, EyeOff, CheckCircle, UserPlus } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-5 py-10">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Sign up to start ordering highway food</p>
        </div>

        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
          <div className="w-11 h-11 bg-orange-100 rounded-xl flex items-center justify-center mb-2">
          ...
          <button onClick={handleRegister}
            ...
            {register.isPending ? <Loader2 className="w-5 h-5 animate-spin" /> : <><span>Create Account</span><ArrowRight className="w-4 h-4" /></>}
          </button>
