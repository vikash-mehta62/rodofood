          ...
          {[
            {
              ...
              action: () => window.open('https://wa.me/917580851506'),
            },
            {
              icon: Mail,
              label: 'Email',
              value: 'support@rodofood.com',
              sub: 'For detailed queries & refunds',
              color: 'bg-blue-50 text-blue-600',
              action: () => window.open('mailto:support@rodofood.com'),
            },
            {
              icon: Phone,
              label: 'Phone',
              ...
              action: () => window.open('tel:+917580851506'),
            },
            {
              icon: MapPin,
              label: 'Address',
