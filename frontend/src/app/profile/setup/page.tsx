    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-5 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-5">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button type="button" onClick={() => setRole('customer')}
                className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all ${role === 'customer' ? 'border-orange-400 bg-orange-50' : 'border-gray-200 bg-gray-50 hover:border-gray-300'}`}>
              ...
              <button type="button" onClick={() => setRole('restaurant')}
                className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all ${role === 'restaurant' ? 'border-orange-400 bg-orange-50' : 'border-gray-200 bg-gray-50 hover:border-gray-300'}`}>
          ...
          <button onClick={handleSubmit} disabled={!name.trim() || updateProfile.isPending}
