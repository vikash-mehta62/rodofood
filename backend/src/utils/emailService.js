...
const sendEmailOTP = async (email, otp, name = '') => {
  try {
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'Rodofood <onboarding@resend.dev>',
        to: [email],
        ...
        html: `
          <div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;padding:24px;background:#fff;border-radius:12px;border:1px solid #eee;">
            ...
            <p style="color:#555;font-size:14px;line-height:1.6;">Use the OTP below to verify your email. Valid for <strong>10 minutes</strong>.</p>
            ...
            <p style="color:#999;font-size:12px;text-align:center;">Do not share this OTP with anyone.</p>
